...
; VBE Constants
VBE_MODE = 0x142 ; Mode 0x142 is 1024x768x32bpp, which is widely supported and a good fallback if the preferred mode isn't available.
; VBE_MODE = 0x112 ; Mode 0x112 is 640x480x24bpp, which is more universally supported, especially on older hardware.
